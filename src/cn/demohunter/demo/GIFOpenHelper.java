...
public class GIFOpenHelper {
    ...
    public static byte[] readImageType(InputStream in) {
    	try{
            byte[] bytes = new byte[8];
            in.read(bytes);
            return bytes;
    ...
    public static String readImageType(File file) {
    ...
    public static String getImageFileType(String mimeType) {
    ...
    public static String getImageFileMimeType(File file) {
